export default class Utilities {
    static ui = {
        ...
        forcePanel: document.getElementById('forcePanel'),
        toolbar: document.getElementById('toolbar'),
        // Range Inputs
        worldSizeInput: document.getElementById("worldSize"),
        // Inputs
        worldUnitSelect: document.getElementById("worldUnit"),
        ...
        deleteSelectedButton: document.getElementById('deleteSelected'),
        linkNodesButton: document.getElementById("linkNodes"),
        resetViewButton: document.getElementById("resetView"),
        runAnalysisButton: document.getElementById("runAnalysis"),
        showFormulasButton: document.getElementById("showFormulas"),
        // Outputs
     ...
     */
    static get unit() {
        return this.ui.worldUnitSelect ? this.ui.worldUnitSelect.value : "m";
    }
    ...
    static updateInputs() {
        ...
        this.unit = this.ui.worldUnitSelect ? this.ui.worldUnitSelect.value : "m";
    }
